...
class ClusterLocal(Dask):
    ...
    def __init__(
        ...
        Args:
            ...
            job_script_prologue (list, opt): List of commands to be executed before starting a
                worker.
            job_extra_directives (list, opt): List of extra SLURM directives (e.g.
                ["--constraint=skylake"]).
        """
        ...
        self.job_extra_directives = job_extra_directives or []
    ...
    def _start_cluster_and_connect_client(self):
        ...
        dask_cluster_kwargs = {
            ...
            "walltime": walltime,
            "log_directory": str(self.experiment_dir / "logs"),
            ...
            # keep this hardcoded to 1, the number of threads for the mpi run is handled byExpand commentComment on lines R156 to R158Resolved
